...
//#define GearboxStep_DtoP 1600*5.61/360 // gear box of step motor
#define GearboxStep_DtoP 1600*13.7*6.5/360 // gear box of step motor
...
int main(void)
{
	...
	//========STEP MOTOR SET PIN
	HAL_GPIO_WritePin(GPIOB, EN_Pin, GPIO_PIN_RESET); //Enable Step
